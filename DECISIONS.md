...
| 2026-08-20 | REJECTED | Full match-screen restyling is not the character art-direction audition. | PR #44 answered the wrong question and must remain unmerged. Do not use its eight match screens as art-style candidates. |
| 2026-08-20 | ACCEPTED | Return to the `audition-r5` two-layer character presentation for art-style selection. | Compare a simple readable full-body gameplay figure with a much more detailed battle-face portrait behind it, in A/B/C sheets. |
| 2026-08-20 | ACCEPTED | Select line, face, paint, proportions and the normal/battle rendering gap before final character concepts or screen translation. | Hold representative identities and composition constant for R6 style calibration; after selection, explore genuinely different character archetypes inside the winning art language. |
